...
| Personal pronouns (accusative) — SELECTION by grammatical gender | LEARNING, newly taught | Initially WRONG, now good | Selecting the pronoun for a German noun (der Apfel → ihn, das Kind → es) was 0/2 before the rule was stated, then 4/4 across all three genders after. Rule only taught at the end of 2026-09-03 | Was mapping by ENGLISH semantics (thing→es, person→ihn) instead of grammatical gender. See ERROR_LOG | 2026-09-03 | 2026-09-05 | Yes — cold check required, same-round success proves nothing (cf. verb-second 2026-09-02) |
