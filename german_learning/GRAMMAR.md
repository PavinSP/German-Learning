...
| Word order: verb-second (general, not just questions) | FUNCTIONAL | Good | Held clean across a genuine overnight retest (4/4, incl. after "so") after earlier regressing once. **2026-09-11 concepts test:** rule stated correctly (2nd position/slot, not 2nd word), "Heute esse ich einen Apfel" correct. Extended to subordinate clauses: correctly separated weil (sends its own verb to the end) from denn (doesn't) | Missed that the WHOLE weil-clause fills position 1 of the main clause, so the main verb still must be 2nd ("Weil es regnet, bleibe ich..." not "...ich bleibe...") — isolated retest 1/1 clean once pointed out | 2026-09-11 | 2026-09-18 | Yes |
