...
| **Next action** | Past tense (Perfekt/Präteritum) planned for tomorrow (Wed = new-grammar day per STUDY_PLAN.md). A1-L7 (transport/directions) vocab started tonight — 8/13 words KNOWN, "an der Ecke" needs a retest. Remaining A1 grammar gaps: regular verb conjugation pattern, key irregular verbs, nominative case as a named concept. Also open: aus-vs-von word-choice drill, weil verb-last 2-day recheck |
| **Blocking?** | No |
