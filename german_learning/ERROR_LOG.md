...
Resolved entries have been moved to archive/ERROR_LOG_ARCHIVE.md — see there for full history.

Repeated mistakes automatically become revision material.

Format per entry:

```
### [category] short description
- Incorrect: <learner's sentence>
...
Categories: article | conjugation | word-order | case (acc/dat) | preposition |
adjective-ending | plural | tense | anglicism | vocab-confusion | spelling | other
